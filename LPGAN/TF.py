...
def processImg(file_in_name, file_out_name_without_ext):
    ...
    print("inside processImg, after pad_, before input_img")
    ...
    for y in range(padrf, h+padrf, patch):
        ...
        for x in range(padrf, w+padrf, patch):
            ...
            print("inside processImg, after crop_img")
            ...
            print("inside processImg, after x_list")
        y_list.append(np.concatenate(x_list, axis=1))
        print("inside processImg, after y_list")
    ...
    print("inside processImg, after enhance_img")
    #try:
